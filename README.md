...
- main()
  - generates the following output:
    `Baseline & Subsidy DF shape, ev_intervention_fanchart.png, Baseline final X_mean, Subsidy  final X_mean, ev_phase_plot.png, ev_spaghetti.png, ev_density.png, ev_ratio_sweep.png`
- traces_to_long_df_networks, compute_dx_dt_safe, plot_dx_dt_comparison
  - computes adoption speed by using dx/dt of the spaghetti plots generated from main()
